...
/**
 * Created by Matthew on 15/03/2016.
 */
public class DrawerAdapter extends RecyclerView.Adapter<DrawerAdapter.ViewHolder> {
    ...
    private Context ctx;
    private MainActivity.OnItemTouchListener listner;



    public DrawerAdapter(String Titles[], int Icons[], Account Profile, Context ctx, MainActivity.OnItemTouchListener listner){ // MyAdapter Constructor with titles and icons parameter
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View itemView,int ViewType) {                 // Creating ViewHolder Constructor with View and viewType As a parameter
            ...
            if(ViewType == TYPE_ITEM) {
                ...
                navBackdrop = (ImageView) itemView.findViewById(R.id.navbackdrop);
    ...
    private void bind(final View item, final int position, final MainActivity.OnItemTouchListener  listener) {
    ...
    public void onBindViewHolder(DrawerAdapter.ViewHolder holder, int position) {
        if(holder.Holderid ==1) {                              // as the list view is going to be called after the header view so we decrement the
            ...
            bind(holder.itemView, position, listner);
